...
if(isset($_SESSION['file_exists'])) {
  echo "<script>alert('$_SESSION[file_exists]')</script>";
...
<tbody>
  ...
  <?php foreach($results as $row):?>  
    <tr>
      ...
      <td><a href='downloads.php?file_id=<?php echo $row['ID']; ?>'  class="btn btn-sm btn-outline-primary"><i class="fa fa-download"></i></a> <a href='delete.php?ID=<?php echo $row['ID']; ?>'  class="btn btn-sm btn-outline-danger"><i class="fa fa-trash"></i></a>
    </tr>
  <?php endforeach; ?>
</tbody>
   </table>
