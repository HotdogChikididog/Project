...
<!-- 
              ...
              <?php
                    ...
                    //  }else{
                       ...
                       require_once("include/connection.php");
                             ...
                             $sql ="SELECT uf.*, COALESCE(lu.NAME, al.NAME) as UPLOADER_NAME,count(UPLOADER_ID) as count FROM upload_files as uf LEFT JOIN login_user as lu ON uf.UPLOADER_ID = lu.ID LEFT JOIN admin_login as al ON uf.UPLOADER_ID = al.ID  group by UPLOADER_ID;";
  ...
  <?php
// Include the logic for dynamic content based on the page parameter
if (isset($_GET['page'])) {
    $page = $_GET['page'];
    $pageFileName = $page . '.php'; // Assuming your dynamic content files have the .php extension
